...
(function() {
  ...
  const navItems = [
    ...
    { section: '🎵 Ramón Orlando', items: [
      ...
      { icon: '🎵', label: 'TikTok Ads', href: 'https://ads.tiktok.com/', keywords: 'tiktok ads campañas publicidad viral', external: true },
      { icon: '💼', label: 'LinkedIn Ads', href: 'https://www.linkedin.com/campaignmanager/', keywords: 'linkedin ads campañas publicidad profesionales b2b', external: true },
